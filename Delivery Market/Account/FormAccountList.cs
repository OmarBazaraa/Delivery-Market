...
namespace DeliveryMarket.Account {
	...
	public partial class FormAccountList : Form {
		...
		private void LoadAccountDetails() {
			...
			decimal rating = Convert.ToDecimal(mData[AccountEntry.DER_RATING]);
			...
			textCreationDate.Text = Convert.ToDateTime(mData[AccountEntry.COL_CREATION_DATE]).ToString("dd/MM/yyyy");
			textGender.Text = mData[AccountEntry.COL_GENDER].ToString();
			textBirthDate.Text = Convert.ToDateTime(mData[AccountEntry.COL_BIRTHDATE]).ToString("dd/MM/yyyy");
